		...
		<div id="myinfo">
			<form action="userController.jsp" method="post">
				...
				<table border="1" class="table table-striped table-hover">
					...
					<tr>
						<th>주소</th>
						<td><input class="form-control" type="text" name="address" value="${dto.taddress}"/></td>
					</tr>
					<tr>
						<th>전화번호</th>
						<td><input class="form-control" type="tel" name="phone" value="${dto.tphone}"/></td>
					</tr>
					<tr>
						<th>이메일</th>
						<td><input class="form-control" type="email" name="email" value="${dto.temail}"/></td>
					</tr>
					<tr>
						<td colspan="2">
							<button class="btn btn-primary" type="submit">수정</button>
							<button class="btn btn-primary" type="button" 
							   onclick="delUser('${dto.tid}')">탈퇴</button>
						</td>
					</tr>
				</table>
			</form>
