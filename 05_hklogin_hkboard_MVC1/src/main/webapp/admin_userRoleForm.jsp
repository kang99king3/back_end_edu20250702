					...
					<tr>
						...
						<td>
							<select name="role" class="form-select">
								<option value="ADMIN" ${dto.trole eq 'ADMIN'?'selected':''}>관리자</option>
								<option value="MANAGER" ${dto.trole eq 'MANAGER'?'selected':''}>정회원</option>
								<option value="USER" ${dto.trole eq 'USER'?'selected':''}>일반회원</option>
							</select>
						</td>
					</tr>
					<tr>
